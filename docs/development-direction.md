...
> **历史方案（已停止作为毕设与实现合同）**
>
> 2026-09-20 起，毕设主线已调整为“科研辅助 PoC”，唯一现行规划见 [科研辅助 PoC 规划与实施合同](literature-research-poc-plan.md)。
> 本文仅保留 2026-07-20 时点的审计和路线设想；其中多智能体调度主线、分支状态、工作树数量及优先级不得作为当前事实或任务依据。
